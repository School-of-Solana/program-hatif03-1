...
**Default Solana Cluster**: The application is configured for Solana Devnet. For local development, you can use a local validator. Ensure your Solana CLI is set to the correct cluster.

```bash
# For Devnet (production)
...
**Note:** The program is deployed to Devnet with Program ID: `8jEXKrgnFUstSuFvGBbn5tLU9GQQbteuvvAwBCGPyBee`
